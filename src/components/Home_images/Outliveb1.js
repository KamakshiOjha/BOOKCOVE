...
export default function Outliveb1() {
  return (
    <>
    <div>
    <p className="para55"><Link to="/">← Back</Link></p>
    </div>
            ...
            <div className="about_content">
                <p className="para1_b2"><h1 className="h3_tag2">Outlive: The Science and Art of Longevity</h1></p>
                    ...
                    <div className="paragraphs">
                        ...
                        <p>This is not “biohacking,” it’s science: a well-founded strategic and tactical approach to extending lifespan while also improving our physical, cognitive, and emotional health. Dr. Attia’s aim is less to tell you what to do and more to help you learn how to think about long-term health, in order to create the best plan for you as an individual. In Outlive , readers will discover:
                        </p>
                    </div>
